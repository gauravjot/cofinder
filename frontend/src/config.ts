...
export const VERSION_CODE: string = "1.1.3";
export const VERSION_DATE: string = "May 29, 2024";
export const VERSION_RELEASE_PAGE = "https://github.com/gauravjot/cofinder/pull/2";
